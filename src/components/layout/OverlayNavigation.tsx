...
export function OverlayNavigation({ children }: OverlayNavigationProps) {
  ...
  return (
    <div className="relative h-full">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-10">
        <div className="flex justify-around items-center p-3">
          ...
          >
            ...
            <span className="text-xs mt-1">How to Play</span>
          </button>
          ...
          >
            ...
            <span className="text-xs mt-1">Game Modes</span>
          </button>
      ...
      {/* Overlay panels */}
      {activeOverlay && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-20 flex justify-center items-start pt-4 sm:pt-12">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-11/12 mx-auto overflow-hidden max-h-[90vh] flex flex-col">
            {/* Overlay header */}
                ...
                <div className="space-y-4">
                  ...
                  <div className="mt-4">
                    ...
                    <div className="flex flex-col space-y-2">
                      <div className="bg-green-100 p-2 rounded text-center font-medium">CAT</div>
                      <div className="bg-blue-100 p-2 rounded text-center font-medium">COT</div>
                      <div className="bg-blue-100 p-2 rounded text-center font-medium">COG</div>
                      <div className="bg-red-100 p-2 rounded text-center font-medium">DOG</div>
                    </div>
              ...
              {activeOverlay === 'gameModes' && (
                <div className="space-y-4">
                  <button
                    ...
                    className="w-full text-left p-4 bg-blue-50 hover:bg-blue-100 rounded-lg flex justify-between items-center"
                  >
                    <div>
                      <h3 className="font-bold text-lg text-blue-700">Daily Challenge</h3>
                      <p className="text-sm text-gray-600">A new puzzle every day. Compete with others globally.</p>
                    </div>
                  ...
                  <button
                    ...
                    className="w-full text-left p-4 bg-purple-50 hover:bg-purple-100 rounded-lg flex justify-between items-center"
                  >
                    <div>
                      <h3 className="font-bold text-lg text-purple-700">Timed Mode</h3>
                      <p className="text-sm text-gray-600">Race against the clock. Solve puzzles before time runs out.</p>
                    </div>
                  ...
                  <button
                    ...
                    className="w-full text-left p-4 bg-indigo-50 hover:bg-indigo-100 rounded-lg flex justify-between items-center"
                  >
                    <div>
                      <h3 className="font-bold text-lg text-indigo-700">Endless Mode</h3>
                      <p className="text-sm text-gray-600">Solve as many chains as you can. How far can you go?</p>
                    </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-white p-3 rounded shadow-sm">
                        ...
                        <div className="text-xs text-gray-500">Puzzles Solved</div>
                      </div>
                      <div className="bg-white p-3 rounded shadow-sm">
              ...
              {activeOverlay === 'leaderboard' && (
                <div className="space-y-4">
                  ...
                  <div className="flex space-x-2">
                    <button className="flex-1 py-2 bg-blue-100 text-blue-800 rounded-lg font-medium">Daily</button>
                    <button className="flex-1 py-2 bg-gray-100 text-gray-800 rounded-lg font-medium">Weekly</button>
                    <button className="flex-1 py-2 bg-gray-100 text-gray-800 rounded-lg font-medium">All Time</button>
                  </div>
                  
                  <button
                    onClick={() => navigateToGameMode('/leaderboard')}
                    className="w-full py-2 mt-2 border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50"
                  >
