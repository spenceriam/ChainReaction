-- Additional tables for ChainReaction game - FIXED VERSION
-- This script creates the remaining tables needed according to the PRD

-- IMPORTANT: Define admin role function FIRST before any policies reference it
